...
namespace Level.UI
{
    public class KnightCombometer : MonoBehaviour
    {
        ...
        //Устновить комбометр
        public void StartCombometer(int combometerNeededPoints)
        {
            this.size = combometerNeededPoints;
            ...
            ActivateLight(false, false);
            ActivateLight(true, false);
        }
        ...
        {
            Debug.Log($"KnightCombometer.ActivateLight({isRed}, {activate})");
            if(!isRed)
            {
